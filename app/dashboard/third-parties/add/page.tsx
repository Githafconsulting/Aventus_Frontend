    ...
    <DashboardLayout>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          {/* Document Applicability Toggle Buttons */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => handleWorkflowChange("quote_sheet_applicable", !workflowConfig.quote_sheet_applicable)}
                  className={`relative w-20 h-8 rounded-full transition-all duration-300 ${
                    workflowConfig.quote_sheet_applicable
                      ? "bg-[#FF6B00]"
                      : theme === "dark"
                      ? "bg-gray-700"
                      : "bg-gray-300"
                ...
                >
                  <div className={`absolute top-0.5 bottom-0.5 w-14 rounded-full bg-white shadow-md transition-all duration-300 flex items-center justify-center font-bold text-xs ${
                    ...
                    {workflowConfig.quote_sheet_applicable ? "YES" : "NO"}
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => handleWorkflowChange("cds_applicable", !workflowConfig.cds_applicable)}
                  className={`relative w-20 h-8 rounded-full transition-all duration-300 ${
                    workflowConfig.cds_applicable
                      ? "bg-[#FF6B00]"
                      : theme === "dark"
                      ? "bg-gray-700"
                      : "bg-gray-300"
                ...
                >
                  <div className={`absolute top-0.5 bottom-0.5 w-14 rounded-full bg-white shadow-md transition-all duration-300 flex items-center justify-center font-bold text-xs ${
                    ...
                    {workflowConfig.cds_applicable ? "YES" : "NO"}
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => handleWorkflowChange("cost_sheet_applicable", !workflowConfig.cost_sheet_applicable)}
                  className={`relative w-20 h-8 rounded-full transition-all duration-300 ${
                    workflowConfig.cost_sheet_applicable
                      ? "bg-[#FF6B00]"
                      : theme === "dark"
                      ? "bg-gray-700"
                      : "bg-gray-300"
                ...
                >
                  <div className={`absolute top-0.5 bottom-0.5 w-14 rounded-full bg-white shadow-md transition-all duration-300 flex items-center justify-center font-bold text-xs ${
                    ...
                    {workflowConfig.cost_sheet_applicable ? "YES" : "NO"}
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => handleWorkflowChange("work_order_applicable", !workflowConfig.work_order_applicable)}
                  className={`relative w-20 h-8 rounded-full transition-all duration-300 ${
                    workflowConfig.work_order_applicable
                      ? "bg-[#FF6B00]"
                      : theme === "dark"
                      ? "bg-gray-700"
                      : "bg-gray-300"
                ...
                >
                  <div className={`absolute top-0.5 bottom-0.5 w-14 rounded-full bg-white shadow-md transition-all duration-300 flex items-center justify-center font-bold text-xs ${
                    ...
                    {workflowConfig.work_order_applicable ? "YES" : "NO"}
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => handleWorkflowChange("proposal_applicable", !workflowConfig.proposal_applicable)}
                  className={`relative w-20 h-8 rounded-full transition-all duration-300 ${
                    workflowConfig.proposal_applicable
                      ? "bg-[#FF6B00]"
                      : theme === "dark"
                      ? "bg-gray-700"
                      : "bg-gray-300"
                ...
                >
                  <div className={`absolute top-0.5 bottom-0.5 w-14 rounded-full bg-white shadow-md transition-all duration-300 flex items-center justify-center font-bold text-xs ${
                    ...
                    {workflowConfig.proposal_applicable ? "YES" : "NO"}
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => handleWorkflowChange("cohf_applicable", !workflowConfig.cohf_applicable)}
                  className={`relative w-20 h-8 rounded-full transition-all duration-300 ${
                    workflowConfig.cohf_applicable
                      ? "bg-[#FF6B00]"
                      : theme === "dark"
                      ? "bg-gray-700"
                      : "bg-gray-300"
                ...
                >
                  <div className={`absolute top-0.5 bottom-0.5 w-14 rounded-full bg-white shadow-md transition-all duration-300 flex items-center justify-center font-bold text-xs ${
                    ...
                    {workflowConfig.cohf_applicable ? "YES" : "NO"}
                  </div>
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  type="button"
                  onClick={() => {
                    const newValue = !workflowConfig.contractor_contract_applicable;
                    handleWorkflowChange("contractor_contract_applicable", newValue);
                    if (!newValue) {
                ...
                >
                  <div className={`absolute top-0.5 bottom-0.5 w-14 rounded-full bg-white shadow-md transition-all duration-300 flex items-center justify-center font-bold text-xs ${
                    ...
                    {workflowConfig.contractor_contract_applicable ? "YES" : "NO"}
                  </div>
                </button>
              </div>
            ...
            <div className={`p-4 rounded-lg border ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => handleWorkflowChange("schedule_form_applicable", !workflowConfig.schedule_form_applicable)}
                  className={`relative w-20 h-8 rounded-full transition-all duration-300 ${
                    workflowConfig.schedule_form_applicable
                      ? "bg-[#FF6B00]"
                      : theme === "dark"
                      ? "bg-gray-700"
                      : "bg-gray-300"
                ...
                >
                  <div className={`absolute top-0.5 bottom-0.5 w-14 rounded-full bg-white shadow-md transition-all duration-300 flex items-center justify-center font-bold text-xs ${
                    ...
                    {workflowConfig.schedule_form_applicable ? "YES" : "NO"}
                  </div>
                </button>
              </div>
            </div>
